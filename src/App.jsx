    ...
    <div className="bg-white ">
      ...
      <div className="w-screen h-20 fixed flex flex-shrink items-center opacity-85 bg-black text-white">
        <div className="flex gap-4 pl-8 items-center w-full md:w-auto">
          ...
          <a href="#home">
            <p className="text-3xl sm:w-[24rem] flex-grow lg:w-[52rem] font-bold  font-f2">Jagadeesh Chakali</p>
          </a>
        </div>
        ...
        <button className="text-white text-4xl mr-8 md:hidden p-6" onClick={() => setMenuOpen(!menuOpen)}>
          <BsList />
        </button>
        {menuOpen && (
        <div className="absolute top-20 left-0 w-full bg-white text-black opacity-75 text-opacity-100 flex flex-col items-center text-xl gap-4 py-4">
          <a className="hover:underline rounded-full text-center px-1" href="#home">Home</a>
      ...
      {/* Side bar */}
      <div className="w-14 p-4 text-white opacity-85 bg-[#7843E9] flex flex-col gap-8 rounded-lg  fixed left-1 top-1/4 ">
        ...
        <a href='https://leetcode.com/u/Jagadeesh02/' target='_blank'><SiLeetcode className='text-3xl'/></a>
        <a href='https://www.instagram.com/j.a.g.a.d.e.e.s.h_15/' target='_blank'><FaInstagramSquare className='text-3xl'/></a>
      </div>
      {/* Scroll UP */}
      <div className="w-14 h-14  flex rounded-full opacity-85 bg-[#7843E9] text-white text-2xl  items-center justify-center fixed right-10 bottom-10">
      ...
      <section className="h-[38rem] pt-20  flex flex-col bg-background bg-current  justify-center items-center  " id="home" >
        ...
        <a className=" mt-20 px-24 py-3 text-xl rounded-lg border-solid text-white border-2 border-black bg-[#7843E9] hover:bg-[#8653f2]" href={Cv} download="Jagadeesh_CV" role="button">Resume</a>
      </section>
      {/* My Skills */}
      <section className=" p-10 ">
        ...
        <div className='flex flex-col items-center p-2 gap-1  '>
          ...
          <div className='flex flex-col items-center p-2 gap-1  '>
            <img src={SkillHTML} alt="Skill" className='w-36 h-20' />
            <p>Html</p>
          </div>
          <div className='flex flex-col items-center p-2 gap-1  '>
            <img src={Skillcss} alt="Skill" className='w-36 h-20' />
            <p>CSS</p>
          </div>
          <div className='flex flex-col items-center p-2 gap-1  '>
            <img src={Skilljs} alt="Skill" className='w-36 h-20' />
            <p>JavaScript</p>
          </div>
          <div className='flex flex-col items-center p-2 gap-1  '>
            <img src={SkillReact} alt="Skill" className='w-36 h-20' />
            <p>React js</p>
          </div>
          <div className='flex flex-col items-center p-2 gap-1  '>
            <img src={Skillnode} alt="Skill" className='w-36 h-20' />
            <p>Node js</p>
          </div>
          <div className='flex flex-col items-center p-2 gap-1  '>
            <img src={Skillexpress} alt="Skill" className='w-36 h-20' />
            <p>Express js</p>
          </div>
          <div className='flex flex-col items-center p-2 gap-1  '>
            <img src={Skillmdb} alt="Skill" className='w-36 h-20' />
            <p>MongoDB</p>
          </div>
          <div className='flex flex-col items-center p-2 gap-1  '>
            <img src={Skillsql} alt="Skill" className='w-36 h-20' />
            <p>PostgreSQL</p>
          </div>
        </div>
      </section>
      ...
      <section className=" py-20 flex flex-col justify-center items-center pb-20 " id="about">
        <div className="text-center container w-[56rem]">
          <p className="font-f3 font-bold text-6xl">ABOUT ME</p>
          <p className="font-f3 text-4xl text-[#7843E9]">---</p>
          <p className="font-f3 text-2xl">Here you will find more information about me, what I do, and my current skills mostly in terms of programming and technology</p>
        </div><br />
        ...
        <a href="#contact" className="bg-[#7843E9] text-white mt-20 px-24 py-3 border-black border-2 border-solid text-xl rounded-lg hover:bg-[#ae7eff]">Contact</a>
      </section>
      {/* Projects */}
      ...
      <section className=" pt-20 pb-20 bg-opacity-90 flex flex-col justify-center items-center bg-background  easy-linear delay-200" id="contact">
        <div className="text-center mb-10 container w-[56rem]">
